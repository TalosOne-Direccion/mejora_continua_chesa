...
export const INITIAL_MACROPROCESOS: import('./types').Macroproceso[] = [
  ...
  { id: 'm6', name: 'Administración', type: 'Soporte', order: 6 },
...
export const INITIAL_PROCESOS: import('./types').Proceso[] = [
  ...
  { id: 'p_bdc_mkt', macroprocesoId: 'm2', name: '1. Mercadotecnia Digital (Marketing)' },
  { id: 'p_bdc_ventas', macroprocesoId: 'm2', name: '2. Ventas Digitales' },
  { id: 'p_bdc_posventa', macroprocesoId: 'm2', name: '3. Posventa Digital' },
  { id: 'p_bdc_calidad', macroprocesoId: 'm2', name: '4. Calidad Digital' },
...
export const INITIAL_PROCEDIMIENTOS: import('./types').Procedimiento[] = [
  // BDC MKT
  { id: 'bdc_mkt_1', procesoId: 'p_bdc_mkt', name: '1. Planeación y Autorización de Pautas', puestos: ['Mercadólogo Agencia', 'Gerente Marketing', 'Coordinador Marketing Digital'], sistemas: ['Correo', 'Google Drive', 'Google Calendar'], herramientas: ['Plantillas de presupuesto', 'Plantillas de parrillas'] },
  { id: 'bdc_mkt_2', procesoId: 'p_bdc_mkt', name: '2. Configuración de Pautas y Generación de Leads', puestos: ['Coordinador Marketing Digital', 'Auxiliar de Marketing'], sistemas: ['CRM Seekop', 'CRM Sale U', 'Google Ads', 'Meta Business Suite'], herramientas: ['Políticas de contenido y uso de marca', 'Copys autorizados'] },
  { id: 'bdc_mkt_3', procesoId: 'p_bdc_mkt', name: '3. Gestión de Contenido Orgánico', puestos: ['Coordinador Marketing Digital', 'Auxiliar de Marketing'], sistemas: ['LinkedIn', 'Meta Business Suite'], herramientas: ['Material gráfico', 'Copys orgánicos'] },
  { id: 'bdc_mkt_4', procesoId: 'p_bdc_mkt', name: '4. Actualización de Catálogo de Seminuevos', puestos: ['Gerentes Seminuevos', 'Auxiliar de Marketing'], sistemas: ['DMS SIA', 'CRM Seekop', 'Facebook', 'Outlet Chesa', 'Milestone'], herramientas: ['Guía Fotos de seminuevos', 'Formulario en Google Drive', 'Políticas de contenido y uso de marca'] },
  { id: 'bdc_mkt_5', procesoId: 'p_bdc_mkt', name: '5. Atención de Hostess BDC', puestos: ['Hostess Digital', 'Asesor Piso Ventas Digital'], sistemas: ['ManyChat (bot IA)', 'CRM Seekop', 'CRM Sale-U', 'Messenger Meta', 'WhatsApp Business'], herramientas: ['Speech oficial de llamada y WhatsApp', 'Rol de guardias APVD/APSD', 'BD general en Drive'] },
  
  // BDC Ventas
  { id: 'bdc_ven_1', procesoId: 'p_bdc_ventas', name: '1. Recepción y Pre-Asignación en CRM', puestos: ['Coordinador Ventas Digitales', 'Hostess Digital'], sistemas: ['CRM Seekop', 'CRM Sale-U'], herramientas: ['Rol de guardias de APVD'] },
  { id: 'bdc_ven_2', procesoId: 'p_bdc_ventas', name: '2. Primer Contacto', puestos: ['Asesor Piso Ventas Digital', 'Coordinador Ventas Digitales'], sistemas: ['CRM Seekop', 'CRM Sale-U', 'WhatsApp Business'], herramientas: ['Speeches de contacto'] },
  { id: 'bdc_ven_3', procesoId: 'p_bdc_ventas', name: '3. Perfilamiento, Agendamiento y Asignación de Escucha a Piso', puestos: ['Asesor Piso Ventas Digital', 'Asesor Piso Ventas 2.0'], sistemas: ['WhatsApp Business', 'CRM Seekop', 'CRM Sale-U'], herramientas: ['Fichas de asignación en WhatsApp por agencia', 'Ubicación y contacto del APV 2.0', 'Cotizador CaFi (enganches 25%-35%)'] },
  { id: 'bdc_ven_4', procesoId: 'p_bdc_ventas', name: '4. Seguimiento a Asignados, Inactivos y Escalamiento', puestos: ['Asesor Piso Ventas Digital', 'Coordinador Ventas Digitales', 'Gerente Ventas'], sistemas: ['CRM Seekop', 'CRM Sale-U'], herramientas: ['Reportes de embudos diarios en Excel', 'Fichas de asignación', 'Llamadas de escalamiento a gerencias'] },
  { id: 'bdc_ven_5', procesoId: 'p_bdc_ventas', name: '5. Rastreo de Ventas Facturadas', puestos: ['Coordinador Ventas Digitales', 'Asesor Piso Ventas Digital'], sistemas: ['CRM Seekop', 'CRM Sale-U', 'DMS SIA', 'Seekop RK'], herramientas: ['Tablas y reportes de cortes de venta (Excel)'] },
  
  // BDC Posventa
  { id: 'bdc_pos_1', procesoId: 'p_bdc_posventa', name: '1. Extracción, Preparación y Cruce de Bases de Datos', puestos: ['Coordinador Posventa Digital'], sistemas: ['DMS SIA', 'Simetrical', 'Dashboard Prosur'], herramientas: ['Tablas de control y limpieza manual (Excel)'] },
  { id: 'bdc_pos_2', procesoId: 'p_bdc_posventa', name: '2. Contacto Omnicanal y Agendamiento', puestos: ['Asesor Piso Ventas Digital'], sistemas: ['Nuxiva', 'Dashboard Prosur', 'DMS SIA'], herramientas: ['Scripts de atención', 'Manteletas de costos y cotizaciones (Prosur)'] },
  { id: 'bdc_pos_3', procesoId: 'p_bdc_posventa', name: '3. Auditoría y Actualización de Datos en Cita', puestos: ['Asesor Piso Ventas Digital', 'Asesores de Servicio'], sistemas: ['DMS SIA', 'Service Tablet'], herramientas: ['Check-list verbal: VIN, placas, correo, teléfono'] },
  { id: 'bdc_pos_4', procesoId: 'p_bdc_posventa', name: '4. Rescate de No-Shows', puestos: ['Asesor Piso Ventas Digital', 'Coordinador Posventa Digital', 'Gerente Posventa'], sistemas: ['DMS SIA', 'WhatsApp Business'], herramientas: ['Bitácora de NO-SHOW', 'Llamadas de reprogramación (2:00 pm)', 'WhatsApp de grupos de agencias'] },
  
  // BDC Calidad
  { id: 'bdc_cal_1', procesoId: 'p_bdc_calidad', name: '1. Sincronización y Envío de Encuesta Inicial', puestos: ['Coordinador Calidad Digital', 'Administradora de Entregas (Agencia)', 'Telencuestadoras'], sistemas: ['DMS SIA', 'Dashboard Prosur', 'Twilio'], herramientas: ['Formatos de mensajería automatizados'] },
  { id: 'bdc_cal_2', procesoId: 'p_bdc_calidad', name: '2. Asignación Manual, Encuesta Telefónica y Filtro', puestos: ['Coordinador Calidad Digital', 'Telencuestadoras'], sistemas: ['Dashboard Prosur', 'Nuxiva', 'Cero Papel'], herramientas: ['Speech oficial de encuestas (CSI/ISI/Rechazos)', 'Cuestionarios en Prosur/Excel para limpieza', 'WhatsApp Business y llamadas telefónicas'] },
  { id: 'bdc_cal_3', procesoId: 'p_bdc_calidad', name: '3. Alertas de Insatisfacción y Escalamiento', puestos: ['Telencuestadoras', 'Coordinador Calidad Digital', 'Gerente Posventa', 'Gerente Ventas'], sistemas: ['Nuxiva', 'Nuxiva'], herramientas: ['Redacción literal de quejas (sin censura) + correo', 'Grabaciones de voz como evidencia'] },
  { id: 'bdc_cal_4', procesoId: 'p_bdc_calidad', name: '4. Cotización y Venta de Seguros Digitales', puestos: ['Ejecutivo Seguros Digital'], sistemas: ['Cotizadores web (Quálitas)', 'Google Drive'], herramientas: ['Drive de pólizas a vencer', 'Bitácora diaria de pólizas a vencer'] },

  // Otros procesos antiguos
...
export const INITIAL_KPIS: import('./types').ProjectKPI[] = [
  ...
  { id: 'kpi_bdc_mkt_2_3', projectId: 'global', name: 'Tasa de contacto de leads (Meta: 15%-30%)', status: 'Propuesto', procedimientoId: 'bdc_mkt_2' },
  ...
  { id: 'kpi_bdc_mkt_5_1', projectId: 'global', name: 'SLA < 10 min', status: 'Propuesto', procedimientoId: 'bdc_mkt_5' },
  ...
  // Ventas Digitales
  { id: 'kpi_bdc_ven_1_1', projectId: 'global', name: 'Asignación de lead en CRM: 10 min', status: 'Propuesto', procedimientoId: 'bdc_ven_1' },
  { id: 'kpi_bdc_ven_1_2', projectId: 'global', name: '0 leads sin asignar o estancados en cola (Seekop)', status: 'Propuesto', procedimientoId: 'bdc_ven_1' },
  { id: 'kpi_bdc_ven_2_1', projectId: 'global', name: 'Tiempo de primera respuesta: SLA < 10 min', status: 'Propuesto', procedimientoId: 'bdc_ven_2' },
  { id: 'kpi_bdc_ven_2_2', projectId: 'global', name: 'Contactabilidad efectiva > 90%', status: 'Propuesto', procedimientoId: 'bdc_ven_2' },
  { id: 'kpi_bdc_ven_3_1', projectId: 'global', name: 'Citas digitales: 5 diarias por APVD', status: 'Propuesto', procedimientoId: 'bdc_ven_3' },
  { id: 'kpi_bdc_ven_3_2', projectId: 'global', name: 'Tasa de conversión a citas ≥ 60%', status: 'Propuesto', procedimientoId: 'bdc_ven_3' },
  { id: 'kpi_bdc_ven_3_3', projectId: 'global', name: 'Cero inactivos en el CRM', status: 'Propuesto', procedimientoId: 'bdc_ven_3' },
  { id: 'kpi_bdc_ven_4_1', projectId: 'global', name: 'Regla de 72 hrs (descarte del lead)', status: 'Propuesto', procedimientoId: 'bdc_ven_4' },
  { id: 'kpi_bdc_ven_4_2', projectId: 'global', name: 'Reasignación de leads: SLA 3-4 min', status: 'Propuesto', procedimientoId: 'bdc_ven_4' },
  { id: 'kpi_bdc_ven_5_1', projectId: 'global', name: 'Meta mínima: 11 ventas facturadas/mes por APVD', status: 'Propuesto', procedimientoId: 'bdc_ven_5' },
  { id: 'kpi_bdc_ven_5_2', projectId: 'global', name: 'Mezcla: 60% Flujo Alto, 30% Flujo Medio, 10% Flujo Bajo', status: 'Propuesto', procedimientoId: 'bdc_ven_5' },
  ...
  { id: 'kpi_bdc_pos_1_2', projectId: 'global', name: 'Depuración de duplicados/inactivos (12 m)', status: 'Propuesto', procedimientoId: 'bdc_pos_1' },
  { id: 'kpi_bdc_pos_2_1', projectId: 'global', name: 'Citas de 1er Servicio', status: 'Propuesto', procedimientoId: 'bdc_pos_2' },
  { id: 'kpi_bdc_pos_2_2', projectId: 'global', name: 'Cobertura BDC en taller: 60%-70%', status: 'Propuesto', procedimientoId: 'bdc_pos_2' },
  { id: 'kpi_bdc_pos_3_1', projectId: 'global', name: 'Datos incorrectos/basura < 3% de la base', status: 'Propuesto', procedimientoId: 'bdc_pos_3' },
  ...
  { id: 'kpi_bdc_pos_4_4', projectId: 'global', name: 'Retención (10 años)', status: 'Propuesto', procedimientoId: 'bdc_pos_4' },
